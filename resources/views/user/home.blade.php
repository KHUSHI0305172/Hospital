  ...
  <footer class="page-footer">
    <div class="container">
      <div class="row px-md-3">
        ...
        <div class="col-sm-6 col-lg-3 py-3">
          <h5>Contact</h5>
          <p class="footer-link mt-2">New Ranip, Ahmedabad,Gujarat 02038</p>
          <a href="#" class="footer-link">701-573-7582</a>
          <a href="#" class="footer-link">OneHealth.net</a>
      ...
      <p id="copyright">Copyright &copy; 2023 Khushali Mukeshbhai Parikh. All right reserved</p>
    </div>
  </footer>
